...
class get_dloader():
    def __init__(self, root, dataset, meta_batch_size, n_spt, img_size):
    ...
    def get_dataset(self):
        if self.name == 'mnist':
            dset = datasets.MNIST(root=self._root, download=True, train=True, transform=self.transform)
        elif self.name == 'fmnist':
            dset = datasets.FashionMNIST(root=self._root, download=True, train=True, transform=self.transform)
        elif self.name == 'kmnist':
            dset = datasets.KMNIST(root=self._root, download=True, train=True, transform=self.transform)
        return dset
